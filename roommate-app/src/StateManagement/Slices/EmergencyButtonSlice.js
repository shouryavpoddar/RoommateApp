...
const initialState = {
    buttons: {
        1 : {title : 'Predefined Emergency', message: 'Predefined Emergency Message', bgColor: 'bg-red-500'},
        2 : {title: 'Test Emergency', message: 'Test emergency message', bgColor: 'bg-green-500'},
    }
};
...
const emergencyButtonSlice = createSlice({
    ...
    reducers: {
        addEmergencyButton: (state, action) => {
            ...
            state.buttons[id] = {title: title, message: message, bgColor: bgColor};
        ...
        editEmergencyButton: (state, action) => {
            ...
            if (state.buttons[buttonId]) {
                state.buttons[buttonId] = { ...state.buttons[buttonId], ...updatedButton };
            }
        },
